...
__decorate([
    (0, swagger_1.ApiProperty)({ example: types_1.TaskStatus.ACCEPTED, enum: types_1.TaskStatus }),
...
], GenerateReportDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2023-09-01T15:20:34.901Z' }),
    (0, class_validator_1.IsDate)({ message: validation_options_1.default.messages.incorrectReportDates }),
    (0, class_transformer_1.Type)(() => Date),
    (0, class_validator_1.IsNotEmpty)({ message: validation_options_1.default.messages.isEmpty }),
    __metadata("design:type", Date)
], GenerateReportDto.prototype, "startDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2023-09-10T15:20:34.901Z' }),
    (0, class_validator_1.IsDate)({ message: validation_options_1.default.messages.incorrectReportDates }),
    (0, class_transformer_1.Type)(() => Date),
    (0, class_validator_1.IsNotEmpty)({ message: validation_options_1.default.messages.isEmpty }),
    __metadata("design:type", Date)
...
], GenerateReportDto.prototype, "check", void 0);
