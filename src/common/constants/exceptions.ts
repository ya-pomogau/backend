export default {
  category: {
    ...
    notEnoughRights: 'Не хватает прав для совершения действия'
  },
  users: {
    ...
    notModified: 'Не удалось обновить данные',
  },
  tasks: {
  ...
  politic: {
    alreadyCreated:
      'Запись с политикой конфиденциальности уже создана. Для редактирования используйте методы PATCH.',
  },
  chats: {
