...
import { ConflictChatWithVolunteerEntity } from './conflict-chat-with-volunteer.entity';
...
import { MessageInterface, ConflictChatWithVolunteerInterface } from '../../common/types/chats.types';
...
describe('ConflictChatWithVolunteerEntity', () => {
  let chatEntity: ConflictChatWithVolunteerEntity;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ConflictChatWithVolunteerEntity,
        { provide: ChatsRepository, useValue: chatsRepository },
        { provide: MessagesRepository, useValue: messagesRepository },
      ],
    }).compile();

    chatEntity = await module.resolve<ConflictChatWithVolunteerEntity>(ConflictChatWithVolunteerEntity);
  });
  ...
  it('should close a chat', async () => {
    const chatId = new Types.ObjectId();
    const metadata: Partial<ConflictChatWithVolunteerInterface> = {
      _id: chatId,
      isActive: true,
    } as unknown as Partial<ConflictChatWithVolunteerInterface>;

    chatEntity['metadata'] = metadata as ConflictChatWithVolunteerInterface;
    chatEntity['chatId'] = chatId.toString();
  ...
  it('should find a chat by params', async () => {
    ...
    const metadata: ConflictChatWithVolunteerInterface = {
      _id: chatId,
      volunteer: {
        name: 'volunteer-name',
        phone: 'volunteer-phone',
